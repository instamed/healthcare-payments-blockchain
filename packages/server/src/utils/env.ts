...
export const CHAINCODE = process.env.CHAINCODE || 'fhir';
...
export const NETWORKPROFILE = join(homedir, `hyperledger-fabric-network/.hfc-${ORG}`);
/* Automatically built from env var ORG_USER */
export const KEYSTORE = join(homedir, `hyperledger-fabric-network/network-profiles/${ORG}.network-profile.yaml`);