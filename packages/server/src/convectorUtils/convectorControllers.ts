...
import { FhirController } from 'fhir-cc';
 ...
 */
export async function InitFhirController(): Promise<FhirController> {
  return ClientFactory(FhirController, await InitFabricAdapter());
}
